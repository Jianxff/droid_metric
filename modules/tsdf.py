...
class RGBDFusion:
    ...
    # static method for running TSDF Fusion
    @staticmethod    
    def pipeline(
        ...
        depth_scale: Optional[float] = 1000.0,                  # depth scale factor
        ...
        mesh = RGBDFusion.extract_mesh(volume, save=mesh_save, viz=viz)
