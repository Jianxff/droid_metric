...
if __name__ == "__main__":
    ...
    parser.add_argument("--rgb", help='dir for rgb image files', type=str, required=True)
    ...
    parser.add_argument("--save_colormap", action='store_true', help='save colormap for depth', default=False)
